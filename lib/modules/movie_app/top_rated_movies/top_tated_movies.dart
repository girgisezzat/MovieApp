...
import 'package:movie_app/modules/movie_app/top_rated_movies/top_tated_movies_details.dart';
...
class TopRatedMoviesScreen extends StatelessWidget {
    ...
    return BlocConsumer<MoviesCubit,MoviesState>(
      ...
      builder: (context,state){
        return Conditional.single(
            context: context,
            conditionBuilder: (context) => MoviesCubit.get(context).top_ratedMovies.length > 0,
                  ...
                  [
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context,index) => InkWell(
                          onTap: (){
                            ...
                            MoviesCubit.get(context).getTopRatedMovies(selected_page);
                          },
                          child: Text(
                            '${index+1}',
                            style: TextStyle(
                    ...
                    GridView.count(
                      ...
                      children: List.generate(
                        MoviesCubit.get(context).top_ratedMovies.length, (index) => buildGridMovie(MoviesCubit.get(context).top_ratedMovies[index], context),
                      ),
                    ),
                  ],
                ),
  ...
  Widget buildGridMovie(MovieModel movieModel,context) {
    ...
    return InkWell(
      onTap: (){
        navigateTo(context,TopRatedMoviesScreenDetails(movieModel));
      },
      child: Container(
