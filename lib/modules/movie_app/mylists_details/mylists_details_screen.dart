...
class MyListsDetailsScreen extends StatelessWidget {

  MovieListModel movieListModel;
  MyListsDetailsScreen({Key? key, required this.movieListModel}) : super(key: key);
                    ...
                    Padding(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) =>
                            buildMovieItem(MoviesCubit.get(context).listMovie[index],context,index),
                        separatorBuilder:(context, index) => SizedBox(height: 8.0,),
                        itemCount: MoviesCubit.get(context).listMovie.length,
                      ),
                    ),
                  ]
              ),
  ...
  Widget buildMovieItem(MovieModel movieModel,context,index){
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: (){
                        MoviesCubit.get(context).removeMovieFromList(listId: movieListModel.listId!,movieId: movieModel.movieId.toString());
                        MoviesCubit.get(context).listMovie.removeAt(index);
                      },
                      child: Row(
