    ...
    return BlocConsumer<MoviesCubit,MoviesState>(
      ...
      builder: (context,state){
        return Conditional.single(
            context: context,
            conditionBuilder: (context) => MoviesCubit.get(context).popularMovies.length > 0,
                  ...
                  [
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context,index) => InkWell(
                            onTap: (){
                              ...
                              MoviesCubit.get(context).getPopularMovies(selected_page);
                            },
                            child: Text(
                              '${index+1}',
                              style: TextStyle(
                    ...
                    GridView.count(
                      ...
                      children: List.generate(
                        MoviesCubit.get(context).popularMovies.length, (index) => buildGridMovie(MoviesCubit.get(context).popularMovies[index], context),
                      ),
                    ),
                  ],
                ),
